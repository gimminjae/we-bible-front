            ...
            <div className="mt-5">
              ...
              <form>
                <div className="grid gap-y-4">
                  ...
                  <div>
                    <label htmlFor="nickname" className="block text-sm mb-2 dark:text-white">Nickname</label>
                    <div className="relative">
                      <input type="nickname" id="nickname" name="nicknameemail"
                             className="py-3 px-4 block w-full border-gray-200 rounded-lg text-sm focus:border-blue-500 focus:ring-blue-500 disabled:opacity-50 disabled:pointer-events-none dark:bg-neutral-900 dark:border-neutral-700 dark:text-neutral-400 dark:placeholder-neutral-500 dark:focus:ring-neutral-600"
                             required aria-describedby="nickname-error"/>
                      <div className="hidden absolute inset-y-0 end-0 pointer-events-none pe-3">
                        <svg className="size-5 text-red-500" width="16" height="16" fill="currentColor"
                    ...
                    <p className="hidden text-xs text-red-600 mt-2" id="nickname-error">Please include a valid email
                      address
                  ...
                  <div>
                    ...
                    <p className="hidden text-xs text-red-600 mt-2" id="confirm-password-error">Password does not match
                      the password</p>
                  </div>
                  {/*// <!-- End Form Group -->*/}
                  ...
                  <div className="flex items-center">
                    ...
                    <div className="ms-3">
                      <label htmlFor="remember-me" className="text-sm dark:text-white">I accept the <a
                        className="text-blue-600 decoration-2 hover:underline font-medium dark:text-blue-500" href="#">Terms
